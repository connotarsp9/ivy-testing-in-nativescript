...
var FrameBase = (function (_super) {
    ...
    FrameBase.prototype.goBack = function (backstackEntry) {
        ...
        if (backstackEntry) {
            var index = this._backStack.indexOf(backstackEntry);
            if (index < 0) {
                return;
            }
        }
    ...
    FrameBase.prototype._updateBackstack = function (entry, navigationType) {
        ...
        if (isBack) {
            var index = this._backStack.indexOf(entry);
            this._backStack.splice(index + 1).forEach(function (e) { return _this._removeEntry(e); });
            this._backStack.pop();
        }
        else if (!isReplace) {
