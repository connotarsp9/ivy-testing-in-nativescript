...
(function (knownFolders) {
    ...
    (function (ios) {
        ...
        function library() {
            ...
            if (!_library) {
                var existingFolderInfo = getExistingFolderInfo(NSSearchPathDirectory.LibraryDirectory);
        ...
        function developer() {
            ...
            if (!_developer) {
                var existingFolderInfo = getExistingFolderInfo(NSSearchPathDirectory.DeveloperDirectory);
                if (existingFolderInfo) {
        ...
        function desktop() {
            ...
            if (!_desktop) {
                var existingFolderInfo = getExistingFolderInfo(NSSearchPathDirectory.DesktopDirectory);
                if (existingFolderInfo) {
        ...
        function downloads() {
            ...
            if (!_downloads) {
                var existingFolderInfo = getExistingFolderInfo(NSSearchPathDirectory.DownloadsDirectory);
                if (existingFolderInfo) {
        ...
        function movies() {
            ...
            if (!_movies) {
                var existingFolderInfo = getExistingFolderInfo(NSSearchPathDirectory.MoviesDirectory);
                if (existingFolderInfo) {
        ...
        function music() {
            ...
            if (!_music) {
                var existingFolderInfo = getExistingFolderInfo(NSSearchPathDirectory.MusicDirectory);
                if (existingFolderInfo) {
        ...
        function pictures() {
            ...
            if (!_pictures) {
                var existingFolderInfo = getExistingFolderInfo(NSSearchPathDirectory.PicturesDirectory);
                if (existingFolderInfo) {
        ...
        function sharedPublic() {
            ...
            if (!_sharedPublic) {
                var existingFolderInfo = getExistingFolderInfo(NSSearchPathDirectory.SharedPublicDirectory);
                if (existingFolderInfo) {
